...
const CourseDetail = ({course}) => {
    ...
    return (
        ...
        <Card.Body>
            ...
            <Card.Text className="font-weight-bold text-center">Sek {price} /kurs <Button className="ml-3" variant="primary"  onClick={()=>handleBuy(_id)} >Order Now/Beställa nu</Button></Card.Text>
